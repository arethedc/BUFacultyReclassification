<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col gap-1">
            <h2 class="text-2xl font-semibold text-gray-800">VPAA Dashboard</h2>
            <p class="text-sm text-gray-500">Review, endorse, and forward reclassification submissions.</p>
        </div>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                <div class="bg-white rounded-2xl shadow-card border border-gray-200 p-6">
                    <div class="text-xs text-gray-500">Pending VPAA Review</div>
                    <div class="text-2xl font-semibold text-gray-800">
                        {{ $statusCounts['vpaa_review'] ?? 0 }}
                    </div>
                </div>
                <div class="bg-white rounded-2xl shadow-card border border-gray-200 p-6">
                    <div class="text-xs text-gray-500">VPAA Endorsed</div>
                    <div class="text-2xl font-semibold text-gray-800">
                        {{ $statusCounts['vpaa_approved'] ?? 0 }}
                    </div>
                </div>
                <div class="bg-white rounded-2xl shadow-card border border-gray-200 p-6">
                    <div class="text-xs text-gray-500">Forwarded to President</div>
                    <div class="text-2xl font-semibold text-gray-800">
                ...
                <div class="lg:col-span-1 flex flex-col gap-6">
                    <div class="bg-white rounded-2xl shadow-card border border-gray-200 p-6">
                        ...
                        <p class="text-sm text-gray-600 mt-2">
                            Endorse complete papers, then forward the cycle list to President.
                        </p>
                        <div class="mt-5 grid grid-cols-1 gap-3">
                            <a href="{{ route('reclassification.review.approved') }}"
                               class="inline-flex items-center justify-center px-4 py-2.5 rounded-xl bg-bu text-white text-sm font-semibold shadow-soft">
                                Open Endorsement List
                            </a>
                            <a href="{{ route('reclassification.review.finalized') }}"
                    ...
                    <div class="bg-white rounded-2xl shadow-card border border-gray-200 p-6">
                        <h3 class="text-lg font-semibold text-gray-800">Period Visibility</h3>
                        <p class="text-sm text-gray-600 mt-2">
                            Active period controls which submissions are visible in review and approval pages.
                        </p>
                    </div>
                </div>
            </div>
